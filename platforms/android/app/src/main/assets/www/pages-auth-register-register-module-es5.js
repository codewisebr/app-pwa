...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(authService, navCtrl, alertService, storage, global, platform, menu, routingService) {
    ...
    RegisterPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.routingService.preloadRoute('dashboard')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.routingService.preloadRoute('admin')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RegisterPage.prototype.permissao = function () {
        var _this = this;
    ...
    RegisterPage.prototype.register = function (form) {
        ...
        this.authService.getAvental().subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
                if (data[i].avental == form.value.avental) {
                    _this.storage.set('avental', data[i].id);
                    break;
                }
            }
        });
        ...
        if (form.value.password != form.value.password_s) {
            ...
            this.authService.register(form.value.fName, form.value.lName, form.value.email, form.value.password, this.daux, this.global.cargo, this.global.avental, this.auxtel, form.value.endereco, form.value.cidade, form.value.estado, form.value.nivel, form.value.profissao).subscribe(function (data) {
                _this.authService.login(form.value.email, form.value.password).subscribe(function (data) {
                }, function (error) {
                    _this.alertService.presentToast("Verifique se você preencheu os campos corretamente");
                }, function () {
                    _this.permissao();
                });
            }, function (error) {
    ...
    RegisterPage.prototype.getCargos = function () {
        var _this = this;
        this.authService.getCargos().subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
    ...
    RegisterPage.prototype.getAvental = function () {
        var _this = this;
        this.authService.getAvental().subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
                _this.avental[i] = data[i].avental;
            }
        }, function (error) {
            //console.log("error: " + error);
        });
