...
var CadastrafinanceiroPageModule = /** @class */ (function () {
    function CadastrafinanceiroPageModule() {
    }
    ...
    return CadastrafinanceiroPageModule;
}());
...
var CadastrafinanceiroPage = /** @class */ (function () {
    function CadastrafinanceiroPage(navCtrl, authService, alertService, routingService) {
        this.navCtrl = navCtrl;
        this.authService = authService;
        this.alertService = alertService;
        this.routingService = routingService;
    }
    CadastrafinanceiroPage.prototype.ngOnInit = function () {
    };
    CadastrafinanceiroPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.routingService.preloadRoute('adminfinanceiro')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CadastrafinanceiroPage.prototype.dismiss = function () {
        this.navCtrl.navigateRoot('/adminfinanceiro');
    };
    CadastrafinanceiroPage.prototype.cadastrar = function (form) {
        var _this = this;
        this.valor = JSON.stringify(form.value.valor);
        this.authService.financeiro(this.valor, form.value.mes).subscribe(function (data) {
            _this.alertService.presentToast("Financeiro criado com sucesso!");
            _this.dismiss();
        }, function (error) {
            _this.alertService.presentToast("Preencha todos os campos!");
        });
    };
    CadastrafinanceiroPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-cadastra-cadastrafinanceiro-cadastrafinanceiro-module-es5.js.map