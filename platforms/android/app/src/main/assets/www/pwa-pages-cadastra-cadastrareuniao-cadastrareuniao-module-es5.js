...
var CadastrareuniaoPageModule = /** @class */ (function () {
    function CadastrareuniaoPageModule() {
    }
    ...
    return CadastrareuniaoPageModule;
}());
...
var CadastrareuniaoPage = /** @class */ (function () {
    function CadastrareuniaoPage(authService, alertService, navCtrl, routingService) {
        this.authService = authService;
        this.alertService = alertService;
        this.navCtrl = navCtrl;
        this.routingService = routingService;
    }
    CadastrareuniaoPage.prototype.ngOnInit = function () {
    };
    CadastrareuniaoPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.routingService.preloadRoute('adminpresenca')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CadastrareuniaoPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/adminpresenca');
    };
    CadastrareuniaoPage.prototype.cadastrar = function (form) {
        var _this = this;
        this.auxdata = form.value.data;
        this.data = this.auxdata.split('T')[0];
        this.authService.createReuniao(this.data).subscribe(function (data) {
            _this.alertService.presentToast(data);
            _this.dismiss();
        });
    };
    CadastrareuniaoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-cadastra-cadastrareuniao-cadastrareuniao-module-es5.js.map