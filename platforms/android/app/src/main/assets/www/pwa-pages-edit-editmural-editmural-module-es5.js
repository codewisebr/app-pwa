...
var EditmuralPageModule = /** @class */ (function () {
    function EditmuralPageModule() {
    }
...
var EditmuralPage = /** @class */ (function () {
    function EditmuralPage(authService, alertService, navCtrl, router, routingService) {
    ...
    EditmuralPage.prototype.ngOnInit = function () { };
    EditmuralPage.prototype.ionViewDidEnter = function () {
    ...
    EditmuralPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    EditmuralPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/mural');
    };
    EditmuralPage.prototype.showMural = function () {
        var _this = this;
        this.authService.getMural().subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
                if (_this.id == data[i].id) {
                    _this.texto = data[i].texto;
                    break;
                }
            }
        });
    };
    EditmuralPage.prototype.editar = function (form) {
        var _this = this;
        this.authService.updateMural(this.id, form.value.texto).subscribe(function (resul) {
            _this.alertService.presentToast("Mural editado com sucesso!");
            _this.dismiss();
        }, function (error) {
            _this.alertService.presentToast('Preencha todos os campos!');
        });
    };
    EditmuralPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-edit-editmural-editmural-module-es5.js.map