...
let HisagapePageModule = class HisagapePageModule {
};
...
let HisagapePage = class HisagapePage {
    constructor(authService, dataPipe, routingService, alertService, alertCtrl) {
    ...
    showAgape() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.authService.getAllAgape().subscribe(data => {
...
//# sourceMappingURL=pwa-pages-historico-hisagape-hisagape-module-es2015.js.map