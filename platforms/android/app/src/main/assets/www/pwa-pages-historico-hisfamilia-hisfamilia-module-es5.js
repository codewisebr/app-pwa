...
var HisfamiliaPageModule = /** @class */ (function () {
    function HisfamiliaPageModule() {
    }
...
var HisfamiliaPage = /** @class */ (function () {
    function HisfamiliaPage(routingService, router, navCtrl, authService, dataPipe) {
    ...
    HisfamiliaPage.prototype.ngOnInit = function () {
    };
    HisfamiliaPage.prototype.ionViewDidEnter = function () {
    ...
    HisfamiliaPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    HisfamiliaPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/adminagape');
    };
    HisfamiliaPage.prototype.showFamilia = function () {
        var _this = this;
        this.authService.getUsers(this.id).subscribe(function (data) {
            _this.nome = data[0].last_name;
        });
        this.authService.getFamilia(this.id).subscribe(function (resp) {
            if (resp == 0)
                _this.hidden = false;
            else {
                _this.hidden = true;
                for (var i = 0; i < resp.length; i++) {
                    _this.familia[i] = resp[i];
                    _this.familia[i].data_nasc = (_this.dataPipe.transform(resp[i].data_nasc, "dd/MM/yyyy"));
                }
            }
        });
    };
    HisfamiliaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-historico-hisfamilia-hisfamilia-module-es5.js.map