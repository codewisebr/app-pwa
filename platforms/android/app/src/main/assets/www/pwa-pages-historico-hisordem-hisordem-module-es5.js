...
var HisordemPageModule = /** @class */ (function () {
    function HisordemPageModule() {
    }
...
var HisordemPage = /** @class */ (function () {
    function HisordemPage(authService, dataPipe, routingService, alertCtrl, alertService) {
    ...
    HisordemPage.prototype.ngOnInit = function () {
    };
    HisordemPage.prototype.ionViewDidEnter = function () {
    ...
    HisordemPage.prototype.ionViewWillEnter = function () {
        this.showOrdem();
    };
    HisordemPage.prototype.showOrdem = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getAllOrdem().subscribe(function (data) {
                            for (var i = 0; i < data.length; i++) {
                                _this.ordem[i] = data[i].ordem;
                                _this.date[i] = (_this.dataPipe.transform(data[i].created_at, "dd/MM/yyyy"));
                                if (data[i].ativo == 1)
                                    _this.ativo[i] = "Sim";
                                else
                                    _this.ativo[i] = "Não";
    ...
    HisordemPage.prototype.popUp = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    HisordemPage.prototype.delete = function () {
        var _this = this;
        this.authService.deleteHistOrdem().subscribe(function (data) {
            window.location.reload();
            _this.alertService.presentToast("Histórico apagado com sucesso!");
        });
    };
    HisordemPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-historico-hisordem-hisordem-module-es5.js.map