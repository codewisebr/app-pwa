...
let HispresencaPageModule = class HispresencaPageModule {
};
...
let HispresencaPage = class HispresencaPage {
    constructor(authService, dataPipe, navCtrl, routingService) {
    ...
    ionViewDidEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.routingService.preloadRoute('hislista');
    ...
    showData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.authService.getAllReuniao()
                .subscribe(resul => {
...
HispresencaPage.ctorParameters = () => [
...
//# sourceMappingURL=pwa-pages-historico-hispresenca-hispresenca-module-es2015.js.map