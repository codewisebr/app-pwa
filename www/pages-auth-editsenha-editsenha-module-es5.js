...
var EditsenhaPageModule = /** @class */ (function () {
    function EditsenhaPageModule() {
    }
...
var EditsenhaPage = /** @class */ (function () {
    function EditsenhaPage(alertService, authService, navCtrl, routingService, global) {
    ...
    EditsenhaPage.prototype.ngOnInit = function () {
    };
    EditsenhaPage.prototype.ionViewWillEnter = function () {
        this.id = this.global.user_id;
    };
    EditsenhaPage.prototype.ionViewDidEnter = function () {
    ...
    EditsenhaPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/account');
    };
    EditsenhaPage.prototype.editar = function (form) {
        var _this = this;
        //verifica a senha atraves da senha
        this.authService.checkPassword(this.id, form.value.password1).subscribe(function (resp) {
            if (resp == false) {
                _this.alertService.presentToast('Senha Incorreta!');
            }
            else if (resp == true) {
                //atualiza a nova senha
                _this.authService.updatePassword(_this.id, form.value.password2).subscribe(function (resp) {
                    _this.alertService.presentToast('Senha atualizada!');
                    _this.navCtrl.navigateRoot('/account');
                }, function (error) {
                    _this.alertService.presentToast('Erro ao tentar atualizar senha, tente mais tarde.');
                });
            }
        }, function (error) {
    ...
    EditsenhaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-auth-editsenha-editsenha-module-es5.js.map