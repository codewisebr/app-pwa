...
var RegisterPage = /** @class */ (function () {
    ...
    RegisterPage.prototype.register = function (form) {
        ...
        if (form.value.password != form.value.password_s) {
            ...
            this.authService.register(form.value.fName, form.value.lName, form.value.email, form.value.password, this.daux, this.global.cargo, form.value.nivel, this.auxtel, form.value.endereco, form.value.cidade, form.value.estado, form.value.profissao).subscribe(function (data) {
