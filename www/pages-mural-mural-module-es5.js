...
var MuralPageModule = /** @class */ (function () {
    function MuralPageModule() {
    }
...
var MuralPage = /** @class */ (function () {
    function MuralPage(authService, modalCtrl, alertService, navCtrl, routingService, global, storage) {
    ...
    MuralPage.prototype.ngOnInit = function () {
    };
    MuralPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.routingService.preloadRoute('cadastramural')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    MuralPage.prototype.ionViewWillEnter = function () {
        this.id = this.global.user_id;
        this.showMural();
    };
    MuralPage.prototype.showMural = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.authService.getMural().subscribe(function (data) {
                    for (var i = 0; i < data.length; i++) {
                        _this.mural[i] = data[i];
                        //se o mural for da pessoa logada
                        if (data[i].id_users == _this.id)
                            _this.mural[i].ativo = 1;
                        else
                            _this.mural[i].ativo = 0;
                    }
                });
                return [2 /*return*/];
            });
    ...
    MuralPage.prototype.cadastrar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    MuralPage.prototype.editar = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    MuralPage.prototype.delete = function (id) {
        var _this = this;
        this.authService.deleteMural(id).subscribe(function (data) {
            window.location.reload();
            _this.alertService.presentToast("Postagem excluída com sucesso!");
        });
    };
    MuralPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-mural-mural-module-es5.js.map