...
let AdminfinanceiroPageModule = class AdminfinanceiroPageModule {
};
...
let AdminfinanceiroPage = class AdminfinanceiroPage {
    constructor(authService, navCtrl, datePipe, alertCtrl, alertService, routingService) {
    ...
    ionViewDidEnter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.routingService.preloadRoute('cadastrafinanceiro');
        });
    }
    ionViewWillEnter() {
        this.showSituacao();
...
AdminfinanceiroPage.ctorParameters = () => [
...
//# sourceMappingURL=pwa-pages-administrador-adminfinanceiro-adminfinanceiro-module-es2015.js.map