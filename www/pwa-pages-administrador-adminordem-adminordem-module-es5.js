...
var AdminordemPageModule = /** @class */ (function () {
    function AdminordemPageModule() {
    }
...
var AdminordemPage = /** @class */ (function () {
    function AdminordemPage(authService, alertService, alertCtrl, navCtrl, modalCtrl, router, routingService) {
    ...
    AdminordemPage.prototype.ngOnInit = function () {
    };
    AdminordemPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.routingService.preloadRoute('editordem')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.routingService.preloadRoute('cadastraordem')];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.routingService.preloadRoute('hisordem')];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AdminordemPage.prototype.ionViewWillEnter = function () {
        this.showOrdem();
        this.permissao();
    };
    AdminordemPage.prototype.permissao = function () {
        var _this = this;
    ...
    AdminordemPage.prototype.showOrdem = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getOrdem().subscribe(function (data) {
                            for (var i = 0; i < data.length; i++) {
                                _this.ordem[i] = data[i];
                            }
                        }, function (error) {
                            // console.log(error);
                        })];
    ...
    AdminordemPage.prototype.cadastrar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AdminordemPage.prototype.editar = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    AdminordemPage.prototype.delete = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getOrdem().subscribe(function (data) {
                            for (var i = 0; i < data.length; i++) {
                                if (id == data[i].id) {
                                    ...
                                    _this.authService.updateOrdem(data[i].id, data[i].ordem, 0, data[i].nivel).subscribe(function (data) {
    ...
    AdminordemPage.prototype.historico = function () {
        this.navCtrl.navigateForward('/hisordem');
    };
    AdminordemPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-administrador-adminordem-adminordem-module-es5.js.map