...
var CadastrafamiliaPageModule = /** @class */ (function () {
    function CadastrafamiliaPageModule() {
    }
    ...
    return CadastrafamiliaPageModule;
}());
...
var CadastrafamiliaPage = /** @class */ (function () {
    function CadastrafamiliaPage(routingService, router, authService, alertService, navCtrl, dataPipe) {
    ...
    CadastrafamiliaPage.prototype.ngOnInit = function () {
    };
    CadastrafamiliaPage.prototype.ionViewDidEnter = function () {
    ...
    CadastrafamiliaPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.router.queryParams.subscribe(function (params) {
            _this.id = params["id"];
        });
    };
    CadastrafamiliaPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/adminusuario');
    };
    CadastrafamiliaPage.prototype.cadastrar = function (form) {
        var _this = this;
        this.data = this.dataPipe.transform(form.value.data, 'yyyy-MM-dd');
        this.authService.familia(this.id, form.value.grau, this.data).subscribe(function (resul) {
            _this.dismiss();
            _this.alertService.presentToast("Familiar cadastrado com sucesso!");
        }, function (error) {
            _this.alertService.presentToast("Preencha todos os campos!");
        });
    };
    CadastrafamiliaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-cadastra-cadastrafamilia-cadastrafamilia-module-es5.js.map