...
let CadastrainfoPageModule = class CadastrainfoPageModule {
};
...
let CadastrainfoPage = class CadastrainfoPage {
    constructor(authService, navCtrl, routingService, alertService) {
    ...
    cadastrar(form) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.authService.user().subscribe(data => {
                this.authService.informativo(form.value.info, data.id, form.value.nivel).subscribe(resul => {
                    this.dismiss();
...
CadastrainfoPage.ctorParameters = () => [
...
//# sourceMappingURL=pwa-pages-cadastra-cadastrainfo-cadastrainfo-module-es2015.js.map