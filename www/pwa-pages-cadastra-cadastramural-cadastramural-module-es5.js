...
var CadastramuralPageModule = /** @class */ (function () {
    function CadastramuralPageModule() {
    }
    ...
    return CadastramuralPageModule;
}());
...
var CadastramuralPage = /** @class */ (function () {
    function CadastramuralPage(authService, alertService, navCtrl, routingService, global) {
    ...
    CadastramuralPage.prototype.ngOnInit = function () {
    };
    CadastramuralPage.prototype.ionViewWillEnter = function () {
        this.id = this.global.user_id;
    };
    CadastramuralPage.prototype.ionViewDidEnter = function () {
    ...
    CadastramuralPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/mural');
    };
    CadastramuralPage.prototype.cadastrar = function (form) {
        var _this = this;
        this.authService.mural(this.id, form.value.texto).subscribe(function (resul) {
            _this.dismiss();
            _this.alertService.presentToast("Mural criado com sucesso!");
        }, function (error) {
            _this.alertService.presentToast("Preencha todos os campos!");
        });
    };
    CadastramuralPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-cadastra-cadastramural-cadastramural-module-es5.js.map