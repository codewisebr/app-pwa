...
var CadastraordemPageModule = /** @class */ (function () {
    function CadastraordemPageModule() {
    }
    ...
    return CadastraordemPageModule;
}());
...
var CadastraordemPage = /** @class */ (function () {
    function CadastraordemPage(authService, alertService, navCtrl, routingService, global) {
    ...
    CadastraordemPage.prototype.ngOnInit = function () {
    };
    CadastraordemPage.prototype.ionViewWillEnter = function () {
        this.id = this.global.user_id;
    };
    CadastraordemPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.routingService.preloadRoute('adminordem')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CadastraordemPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/adminordem');
    };
    CadastraordemPage.prototype.cadastrar = function (form) {
        var _this = this;
        this.authService.ordem(form.value.ordem, this.id, form.value.nivel).subscribe(function (resul) {
            _this.dismiss();
            _this.alertService.presentToast("Ordem cadastrada com sucesso!");
        }, function (error) {
            _this.alertService.presentToast("Preencha todos os campos!");
        });
    };
    CadastraordemPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-cadastra-cadastraordem-cadastraordem-module-es5.js.map