...
let CadastrausuarioPageModule = class CadastrausuarioPageModule {
};
...
let CadastrausuarioPage = class CadastrausuarioPage {
    constructor(authService, alertService, storage, global, dataPipe, navCtrl, routingService) {
    ...
    register(form) {
        ...
        //registra o usuário
        this.authService.register(form.value.fName, form.value.lName, form.value.email, "123456", this.daux, this.global.cargo, form.value.nivel, this.auxtel, form.value.endereco, form.value.cidade, form.value.estado, form.value.profissao).subscribe(data => {
            this.id = data;
...
CadastrausuarioPage.ctorParameters = () => [
...
//# sourceMappingURL=pwa-pages-cadastra-cadastrausuario-cadastrausuario-module-es2015.js.map