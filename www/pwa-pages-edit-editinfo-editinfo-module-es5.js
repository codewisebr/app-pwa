...
var EditinfoPage = /** @class */ (function () {
    function EditinfoPage(authService, alertService, navCtrl, router, routingService) {
    ...
    EditinfoPage.prototype.ngOnInit = function () {
    };
    EditinfoPage.prototype.ionViewDidEnter = function () {
    ...
    EditinfoPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    EditinfoPage.prototype.showInfo = function () {
        var _this = this;
        this.authService.getInfo().subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
                if (_this.id == data[i].id) {
                    _this.inform = data[i].info;
    ...
    EditinfoPage.prototype.dismiss = function () {
        this.navCtrl.navigateRoot('/admininfo');
    };
    EditinfoPage.prototype.editar = function (form) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.authService.getInfo().subscribe(function (data) {
                    for (var i = 0; i < data.length; i++) {
                        if (_this.id == data[i].id) {
                            _this.authService.updateInfo(data[i].id, form.value.novo, 1, form.value.nivel).subscribe(function (data) {
                                _this.dismiss();
                                _this.alertService.presentToast("Informativo editado com sucesso!");
                            }, function (error) {
    ...
    EditinfoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-edit-editinfo-editinfo-module-es5.js.map