...
var EditpresencaPage = /** @class */ (function () {
    function EditpresencaPage(authService, alertService, navCtrl, router) {
    ...
    EditpresencaPage.prototype.ngOnInit = function () {
    };
    EditpresencaPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    EditpresencaPage.prototype.showLista = function () {
        var _this = this;
        this.authService.getLista().subscribe(function (data) {
            for (var i = 0; i < data.length; i++) {
                //pega na lista onde a reuniao esta ativa, o id do usuario
                if (_this.id == data[i].id) {
                    _this.presenca = data[i].presenca;
                    _this.motivo = data[i].motivo;
                    switch (_this.presenca) {
                        case 1:
                            _this.checked1 = "true";
                            break;
                        case 0:
    ...
    EditpresencaPage.prototype.dismiss = function () {
        this.navCtrl.navigateForward('/adminpresenca');
    };
    EditpresencaPage.prototype.editar = function (form) {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getLista().subscribe(function (data) {
                            for (var i = 0; i < data.length; i++) {
                                //checa o id da lista
                                if (_this.id == data[i].id) {
                                    _this.authService.updateLista(data[i].id, form.value.motivo, form.value.presenca).subscribe(function (data) {
                                        _this.dismiss();
                                        _this.alertService.presentToast("Presença editada com sucesso!");
                                    }, function (error) {
    ...
    EditpresencaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-edit-editpresenca-editpresenca-module-es5.js.map