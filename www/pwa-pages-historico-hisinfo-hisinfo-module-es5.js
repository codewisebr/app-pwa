...
var HisinfoPageModule = /** @class */ (function () {
    function HisinfoPageModule() {
    }
...
var HisinfoPage = /** @class */ (function () {
    function HisinfoPage(authService, dataPipe, routingService, alertCtrl, alertService) {
    ...
    HisinfoPage.prototype.ngOnInit = function () {
    };
    HisinfoPage.prototype.ionViewDidEnter = function () {
    ...
    HisinfoPage.prototype.ionViewWillEnter = function () {
        this.showInfo();
    };
    HisinfoPage.prototype.showInfo = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getAllInfo().subscribe(function (data) {
    ...
    HisinfoPage.prototype.popUp = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    HisinfoPage.prototype.delete = function () {
        var _this = this;
        this.authService.deleteHistInfo().subscribe(function (data) {
            _this.alertService.presentToast("Histórico apagado com sucesso!");
            window.location.reload();
        });
    };
    HisinfoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pwa-pages-historico-hisinfo-hisinfo-module-es5.js.map